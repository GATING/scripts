...
!(async () => {
  ...
  authorCodeList = ["fd50fc2b7d53441387b2fd2e4dfacf56"];
  $.shareUuid =
...
async function takePostRequest(type) {
  ...
  switch (type) {
    ...
    case "报名":
      ...
      body = `activityId=${$.activityId}&pin=${encodeURIComponent(
        $.Pin
      )}&actorUuid=${$.actorUuid}&taskType=0&taskValue=`;
      break;
    case "info":
            ...
            if (typeof res.data == "object") {
              ...
              if (type == "followShop") {
                ...
                msg =
                  ...
                  (res.data.wdsrvo.drawOk == true &&
                    ((res.data.wdsrvo.drawInfoType == 6 &&
                      res.data.wdsrvo.name) ||
                      "")) ||
                  "空气💨";
              }
              if (!msg) {
              ...
              if (item.drawId == "dayShareBeans") {
                ...
                console.log(
                  `${
                    (item.infoType != 10 &&
                      item.drawId &&
                      (typeArr[item.drawId] || item.drawId) + ":") ||
