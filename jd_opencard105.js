...
!(async () => {
  ...
  authorCodeList = ["c6a437f82e38496a94a01cd65fcef270"];
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/april/springUnion/activity/${
        $.authorNum
...
async function member() {
  ...
  if ($.token) {
    ...
    if ($.secretPin) {
      ...
      if ($.index === 1) {
        await task(
          "april/springUnion/activityContent",
      ...
      await $.wait(1000);
      await task(
        "april/springUnion/initOpenCard",
