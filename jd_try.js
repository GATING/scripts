...
let args_xh = {
   ...
   */
    ...
    (process.env.XH_TRY_EXCEPT && process.env.XH_TRY_EXCEPT.split("@")) || [],
  //以上环境变量新增于2022.01.30
  /*
...
function requireConfig() {
  return new Promise((resolve) => {
    ...
    if (args_xh.env) {
      ...
      console.log(
        `applyInterval: ${typeof args_xh.applyInterval}, ${
          args_xh.applyInterval
        }`
      );
      console.log(
        `maxLength: ${typeof args_xh.maxLength}, ${args_xh.maxLength}`
      );
      console.log(
      ...
      console.log(
        `whiteList: ${typeof args_xh.whiteList}, ${args_xh.whiteList}`
      );
      console.log(
