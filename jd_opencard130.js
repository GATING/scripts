...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku112
    ? process.env.guaopencard_addSku112
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku112")
  ? $.getdata("guaopencard_addSku112")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard112
    ? process.env.guaopencard112
    : `${guaopencard}`
  : $.getdata("guaopencard112")
  ? $.getdata("guaopencard112")
  : `${guaopencard}`;
guaopencard = $.isNode()
...
!(async () => {
  ...
  let authorCodeList = ["fe81938efa00478f897efbc2e2dc4073"];
