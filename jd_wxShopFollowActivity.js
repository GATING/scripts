...
if (process.env.FOLLOW_SHOW_LIST)
  activityIdList.concat(process.env.FOLLOW_SHOW_LIST.split(","));
let lz_cookie = {};
            ...
            if (data.result) {
              switch (function_id) {
                ...
                case "activityContentOnly":
                  ...
                  console.log(
                    "活动奖品: " + $.activityContent.drawContentVOs[0]["name"]
                  );
                  break;
                case "follow":
                  console.log(data.data);
...
function taskUrl(function_id, body, isCommon) {
  return {
    url: isCommon
      ...
      : `https://lzkj-isv.isvjcloud.com/wxShopFollowActivity/${function_id}`,
    headers: {
