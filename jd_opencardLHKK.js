...
[task_local]
#联合开卡
7 7 7 7 7 jd_speedcoupon.js, tag=联合开卡, enabled=true
================Loon==============
[Script]
cron "7 7 7 7 7" script-path=jd_speedcoupon.js,tag=联合开卡
===============Surge=================
联合开卡 = type=cron,cronexp="7 7 7 7 7",wake-system=1,timeout=3600,script-path=jd_speedcoupon.js
============小火箭=========
联合开卡 = type=cron,script-path=jd_speedcoupon.js, cronexpr="7 7 7 7 7", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  console.log(
    `活动地址:https://jinggengjcq-isv.isvjcloud.com/fronth5/#/pages/unitedCardNew20220302/unitedCardNew20220302?actId=fe595e5ceec04518a151_220302`
  );
