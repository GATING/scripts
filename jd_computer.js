if (!["card", "car"].includes(process.env.FS_LEVEL)) {
  console.log(
    '请设置通用加购/开卡环境变量FS_LEVEL为"car"(或"card"开卡+加购)来运行加购脚本'
  );
  return;
}
/*
...
if ($.isNode()) {
  ...
  if (process.env.computer_activityIdList)
    activityIdList = process.env.computer_activityIdList;
...
!(async () => {
  ...
  if (!activityIdList) {
    ...
    let data = await getData(
      "https://cdn.jsdelivr.net/gh/KingRan/shareCodes@master/dlpj.json"
    );
    if (data && data.length) {
      $.log(`获取到远程且有数据`);
    ...
    if ($.list) {
      for (let i in $.list || []) {
        ...
        for (let j in $.oneTask.taskList || []) {
          ...
          if ($.task.status != 4)
            await doTask("doTask", $.task.id, $.oneTask.taskId);
...
function indexInfo() {
  return new Promise(async (resolve) => {
    let sign = getSign("/tzh/combination/indexInfo", {
...
function doTask(type, id, taskId) {
  if ($.outFlag != 0) return;
  return new Promise(async (resolve) => {
    let sign = getSign(`/tzh/combination/${type}`, {
      activityId: activityId,
      id: id,
      taskId: taskId,
    });
...
function extraTaskPrize() {
  if ($.outFlag != 0) return;
  return new Promise(async (resolve) => {
    let sign = getSign(`/tzh/combination/extraTaskPrize`, {
      activityId: activityId,
    });
    $.post(
      {
...
function M(_0xc44a8f, _0x429a90, _0xdee559) {
  ...
  if (_0xc44a8f) {
    if (_0x4488a6["iRXRX"](_0x4488a6["fzUrQ"], typeof _0xc44a8f))
      _0x1f1f5c = _0x4488a6["VxfTG"](_0xc44a8f, _0x110178);
    else if (
      _0x4488a6["VoKLi"](_0x4488a6["ANdMj"], _0x4488a6["hodih"](x, _0xc44a8f))
    ) {
      if (_0x4488a6["dCNAc"](_0x4488a6["TjWBq"], _0x4488a6["TjWBq"])) {
        if (_0x4488a6["CNgba"](_0x4488a6["fzUrQ"], typeof _0xc44a8f))
          _0x1f1f5c = _0x4488a6["jqqVS"](_0xc44a8f, _0x110178);
        else if (
          _0x4488a6["CAfDO"](
            _0x4488a6["ANdMj"],
            _0x4488a6["zEtiI"](x, _0xc44a8f)
          )
        ) {
          var _0x3ff3f9 = [];
          for (var _0x3a1019 in _0xc44a8f)
            _0x3ff3f9["push"](
              _0x4488a6["jqqVS"](
                _0x4488a6["pujRC"](_0x3a1019, "="),
                _0xc44a8f[_0x3a1019]
              )
            );
          _0x1f1f5c = _0x3ff3f9["length"]
            ? _0x4488a6["VxfTG"](_0x3ff3f9["join"]("&"), _0x110178)
            : _0x110178;
        }
      } else {
        var _0x407463 = [];
        for (var _0x3f044c in _0xc44a8f)
          _0x407463["push"](
            _0x4488a6["BEnKe"](
              _0x4488a6["LBePY"](_0x3f044c, "="),
              _0xc44a8f[_0x3f044c]
            )
          );
        _0x1f1f5c = _0x407463["length"]
          ? _0x4488a6["LBePY"](_0x407463["join"]("&"), _0x110178)
          : _0x110178;
      }
    }
...
function x(_0x543ed7) {
  ...
  return (
    (x =
      _0x59f6a8["HuNNH"](_0x59f6a8["qdkKz"], typeof Symbol) &&
      _0x59f6a8["CYwxT"](_0x59f6a8["chONS"], typeof Symbol["iterator"])
        ? function (_0x543ed7) {
            return typeof _0x543ed7;
          }
        : function (_0x543ed7) {
            return _0x543ed7 &&
              _0x59f6a8["mwjbO"](_0x59f6a8["qdkKz"], typeof Symbol) &&
              _0x59f6a8["VPiUV"](_0x543ed7["constructor"], Symbol) &&
              _0x59f6a8["YVTeQ"](_0x543ed7, Symbol["prototype"])
              ? _0x59f6a8["chONS"]
              : typeof _0x543ed7;
          }),
