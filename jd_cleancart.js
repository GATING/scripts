...
let args_xh = {
   ...
   */
    ...
    (process.env.XH_CLEAN_EXCEPT && process.env.XH_CLEAN_EXCEPT.split("@")) ||
    [],
  /*
   ...
   */
  keywords:
    (process.env.XH_CLEAN_KEYWORDS &&
      process.env.XH_CLEAN_KEYWORDS.split("@")) ||
    [],
};
...
!(async () => {
  if (args_xh.clean) {
    ...
    console.log(
      "你设置了不删除购物车数据，要删除请设置环境变量 JD_CART 为 true"
    );
  }
})()
  .catch((e) => {
