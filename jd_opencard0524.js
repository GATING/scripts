...
async function takePostRequest(type) {
  ...
  switch (type) {
    ...
    case "followShop":
      ...
      body = `activityId=${$.activityId}&pin=${encodeURIComponent(
        $.Pin
      )}&actorUuid=${$.actorUuid}&taskType=23&taskValue=23`;
      break;
    case "sign":
    case "addCart":
    case "browseGoods":
