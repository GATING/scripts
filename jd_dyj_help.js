...
function openRedEnvelopeInteract(body = {}) {
  ...
  return new Promise((resolve) => {
    $.get(
      {
        url:
          "https://api.m.jd.com/?functionId=openRedEnvelopeInteract&body=" +
          JSON.stringify(body) +
          "&t=" +
          Date.now() +
          "&appid=activities_platform&clientVersion=3.5.6",
        headers: {
          Cookie: cookie,
          Accept: "*/*",
...
function redEnvelopeInteractHome() {
  return new Promise((resolve) => {
    $.get(
      {
        url:
          "https://api.m.jd.com/?functionId=redEnvelopeInteractHome&body={%22linkId%22:%22J6BvN4C_Jb01SFG0vSMFJg%22,%22redEnvelopeId%22:%22%22,%22inviter%22:%22%22,%22helpType%22:%22%22}&t=" +
          Date.now() +
          "&appid=activities_platform&clientVersion=3.5.6",
        headers: {
          Cookie: cookie,
