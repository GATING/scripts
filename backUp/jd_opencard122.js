...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku133
    ? process.env.guaopencard_addSku133
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku133")
  ? $.getdata("guaopencard_addSku133")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard133
    ? process.env.guaopencard133
    : `${guaopencard}`
  : $.getdata("guaopencard133")
  ? $.getdata("guaopencard133")
  : `${guaopencard}`;
guaopencard = $.isNode()
  ...
  : `${guaopencard}`;
guaopenwait = $.isNode()
  ? process.env.guaopenwait133
    ? process.env.guaopenwait133
    : `${guaopenwait}`
  : $.getdata("guaopenwait133")
  ? $.getdata("guaopenwait133")
  : `${guaopenwait}`;
guaopenwait = $.isNode()
...
guaopencard_draw = $.isNode()
  ? process.env.guaopencard_draw133
    ? process.env.guaopencard_draw133
    : guaopencard_draw
  : $.getdata("guaopencard_draw133")
  ? $.getdata("guaopencard_draw133")
  : guaopencard_draw;
guaopencard_draw = $.isNode()
