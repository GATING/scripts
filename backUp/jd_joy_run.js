...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["qq674964222", "家庭大美女"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["qq674964222", "家庭大美女"];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["qq674964222", "家庭大美女"];
  ...
  return new Promise((resolve) => {
    ...
    let opt = {
      ...
      url: `//draw.jdfcloud.com/common/pet/enterRoom/h5?reqSource=h5&invitePin=${encodeURI(
        invitePin
      )}&inviteSource=task_invite&shareSource=weapp&inviteTimeStamp=${Date.now()}&invokeKey=${invoke_key}`,
      method: "GET",
      data: {},
      credentials: "include",
  ...
  return new Promise((resolve) => {
    ...
    let opt = {
      ...
      url: `//draw.jdfcloud.com/common/pet/helpFriend?friendPin=${encodeURI(
        friendPin
      )}&reqSource=h5&invokeKey=${invoke_key}`,
      method: "GET",
      data: {},
      credentials: "include",
      header: { "content-type": "application/json" },
