  ...
  return new Promise((resolve) => {
    $.post(
      taskPostUrl("qryCompositeMaterials", {
        ...
        pageId: "3455491",
        qryParam:
          '[{"type":"advertGroup","id":"06167705","mapTo":"advData","next":[{"type":"productGroup","mapKey":"desc","mapTo":"productGroup","attributes":13}]}]',
  ...
  return new Promise((resolve) => {
    $.post(
      taskPostUrl("qryCompositeMaterials", {
        ...
        pageId: "3195530",
        qryParam:
          '[{"type":"advertGroup","id":"06066757","mapTo":"advData","next":[{"type":"productGroup","mapKey":"desc","mapTo":"productGroup","attributes":13}]}]',
        applyKey: "21new_products_h",
      }),
      (err, resp, data) => {
        try {
