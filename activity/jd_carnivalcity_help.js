...
[task_local]
#京东手机狂欢城助力
10 0,8 * * * https://raw.githubusercontent.com/GATING/scripts/main/jd_carnivalcity_help.js, tag=京东手机狂欢城助力, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "10 0,8 * * *" script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_carnivalcity_help.js, tag=京东手机狂欢城助力

====================Surge================
京东手机狂欢城助力 = type=cron,cronexp=10 0,8 * * *,wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_carnivalcity_help.js

============小火箭=========
京东手机狂欢城助力 = type=cron,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_carnivalcity_help.js, cronexpr="10 0,8 * * *", timeout=3600, enable=true
*/
...
function readShareCode() {
  return new Promise(async (resolve) => {
    $.get(
      { url: `https://transfer.nz.lu/carnivalcity`, timeout: 20000 },
      (err, resp, data) => {
        try {
          if (err) {
            console.log(`${JSON.stringify(err)}`);
...
function shareCodesFormat() {
  return new Promise(async (resolve) => {
    ...
    if (readShareCodeRes && readShareCodeRes.code === 200) {
      $.newShareCodes = [
        ...new Set([...$.shareCodes, ...(readShareCodeRes.data || [])]),
      ];
    } else {
