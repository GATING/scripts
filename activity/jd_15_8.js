...
[task_local]
#极速版抢卷
58 59 8,11,14,16,19 * * * https://raw.githubusercontent.com/GATING/scripts/main/jd_29_8.js, tag=极速版抢卷, enabled=true
================Loon==============
[Script]
cron "58 59 8,11,14,16,19 * * *" script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_29_8.js,tag=极速版抢卷
===============Surge=================
极速版抢卷 = type=cron,cronexp="58 59 8,11,14,16,19 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_29_8.js
============小火箭=========
极速版抢卷 = type=cron,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_29_8.js, cronexpr="58 59 8,11,14,16,19 * * *", timeout=3600, enable=true
 */
...
function exchange() {
  return new Promise((resolve) => {
    $.post(
      taskUrl("functionId=lite_newBabelAwardCollection"),
      (err, resp, data) => {
        try {
          if (err) {
            console.log(`${JSON.stringify(err)}`);
            console.log(
              `${$.name} user/exchange/bean API请求失败，请检查网路重试\n`
            );
          } else {
...
var _0xodK = "jsjiami.com.v6",
  ...
  _0xc073 = [
    _0xodK,
    "",
    "\x2a\x2f\x2a",
...
(function (_0x6420b6, _0xe336fe) {
  var _0x36d291 = 0x0;
  for (
    _0xe336fe = _0x6420b6["shift"](_0x36d291 >> 0x2);
    _0xe336fe &&
    _0xe336fe !==
      (_0x6420b6["pop"](_0x36d291 >> 0x3) + "")["replace"](
        /[rKwMdxWZfIbVxJ=]/g,
        ""
      );
    _0x36d291++
...
function taskUrl(_0x26a320, _0x474a3c = {}) {
  return {
    ...
    "\x68\x65\x61\x64\x65\x72\x73": {
      ...
      Referer: _0x32eb("7"),
      Cookie: cookie,
      "User-Agent": $[_0x32eb("8")]()
        ? process[_0x32eb("9")][_0x32eb("a")]
          ? process[_0x32eb("9")][_0x32eb("a")]
          : require(_0x32eb("b"))[_0x32eb("c")]
        : $[_0x32eb("d")](_0x32eb("e"))
        ? $[_0x32eb("d")](_0x32eb("e"))
        : _0x32eb("f"),
    },
