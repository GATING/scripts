...
[task_local]
#京东饭粒
40 0,9,17 * * * https://raw.githubusercontent.com/GATING/scripts/main/jd_fanli.js, tag=京东饭粒, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "40 0,9,17 * * *" script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_fanli.js,tag=京东饭粒

===============Surge=================
京东饭粒 = type=cron,cronexp="40 0,9,17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_fanli.js

============小火箭=========
京东饭粒 = type=cron,script-path=https://raw.githubusercontent.com/GATING/scripts/main/jd_fanli.js, cronexpr="40 0,9,17 * * *", timeout=3600, enable=true
*/
    ...
    if (cookiesArr[i]) {
      ...
      if ($.count.finishCount < $.count.maxTaskCount) {
        ...
        for (let k in $.taskList) {
          if (
            $.taskList[k].taskId !== null &&
            $.taskList[k].statusName != "活动结束" &&
            $.taskList[k].statusName != "明日再来"
          ) {
            CountDoTask += 0;
