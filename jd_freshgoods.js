...
function saveTask(taskType, taskId, itemId) {
  return new Promise((resolve) => {
    $.post(
      taskposturl(
        `code=90542d6a09e34c8f9ae37ec768efd875&taskType=${taskType}&taskId=${taskId}&eid=undefined&fp=undefined&itemId=${itemId}`
      ),
      async (err, resp, data) => {
        try {
          if (err) {
