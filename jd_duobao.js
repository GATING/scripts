...
$.run({ wait: [2000, 3000] }).catch((reason) => console.log(reason));
...
async function finishTask(id, token, activeid) {
  ...
  headers[
    "User-Agent"
  ] = `jdapp;iPhone;10.2.0;14.4.2;${$.uuid()};M/5.0;network/wifi;ADID/;model/iPhone8,1;addressid/0;appBuild/167853;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1;`;
...
async function login(lkToken, token) {
  let body = {
    ...
    token: token,
    returnurl:
      "https://prodev.m.jd.com/mall/active/xiPStZsNkPxpQFXqVRuTv1QGr3x/index.html?showhead=no",
    tttparams:
      "iX8N8eyJsbmciOiIiLCJnTGF0IjoiMzkuODc2NDcyIiwibGF0IjoiIiwiZ0xuZyI6IjExNi43MDM3MDUiLCJncHNfYXJlYSI6IjFfMF8wXzAiLCJ1bl9hcmVhIjoiMV8yODA5XzUxMjMwXzAifQ5==",
    lng: "0.000000",
    lat: "0.000000",
...
async function userToken(param = {}) {
  ...
  let headers = {
    ...
    Referer:
      "https://prodev.m.jd.com/mall/active/xiPStZsNkPxpQFXqVRuTv1QGr3x/index.html",
    Host: "jdjoy.jd.com",
    "Accept-Language": "zh-cn",
    "Accept-Encoding": "gzip, deflate, br",
  };
