...
import { get, o2s, randomString, requireConfig, wait } from "./TS_USER_AGENTS";
...
async function api(fn: string, body: object) {
  ...
  return await get(
    `https://api.m.jd.com/?functionId=${fn}&body=${encodeURIComponent(
      JSON.stringify(body)
    )}&t=${timestamp}&appid=activities_platform&client=H5&clientVersion=1.0.0&h5st=${h5st}`,
    {
      Host: "api.m.jd.com",
      Origin: "https://bnzf.jd.com",
      "User-Agent": `jdapp;iPhone;10.2.2;14.3;${randomString(
        40
