        ...
        if (err) {
          ...
          if (data) {
            ...
            if (data.result.couponConfig.signNecklaceDomain) {
              if (
                data.result.couponConfig.signNecklaceDomain.roundData.ynSign ===
                "1"
              ) {
                ...
                body = {
                  ...
                  sessionId: "",
                  signature:
                    data.result.couponConfig.signNecklaceDomain.signature,
                  pin: pin,
                  verifyToken: "",
                };
              }
              ...
              if (
                data.result.couponConfig.signNewDomain.roundData.ynSign === "1"
              ) {
                console.log(`签到失败：今日已签到~`);
              } else {
                let pin = await getsecretPin($.UserName);
