...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      $.userId = "10299171";
      $.actId = "144ccbe7a1014627bb0_22052002";
              ...
              if (data.data.status === 200) {
                switch (function_id) {
                  case "activity_load":
                    ...
                    console.log(
                      "[ " + data.data.data.cusActivity.actName + " ]"
                    );
                    break;
                  case "shopList":
  ...
  let opt = {
    ...
    headers: {
      ...
      Referer: `https://shopmember.m.jd.com/shopcard/?venderId=${venderId}}&channel=401&returnUrl=${encodeURIComponent(
        "https://jinggengjcq-isv.isvjcloud.com/fronth5"
      )}`,
...
function taskUrl(function_id, body) {
  return {
    url: `https://jinggengjcq-isv.isvjcloud.com/dm/front/openCardNew/${function_id}?&mix_nick=${
      $.buyerNick ? $.buyerNick : ""
    }`,
    headers: {
