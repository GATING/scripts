...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku106
    ? process.env.guaopencard_addSku106
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku106")
  ? $.getdata("guaopencard_addSku106")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard106
    ? process.env.guaopencard106
    : `${guaopencard}`
  : $.getdata("guaopencard106")
  ? $.getdata("guaopencard106")
  : `${guaopencard}`;
guaopencard = $.isNode()
  ...
  : `${guaopencard}`;
guaopenwait = $.isNode()
  ? process.env.guaopenwait106
    ? process.env.guaopenwait106
    : `${guaopenwait}`
  : $.getdata("guaopenwait106")
  ? $.getdata("guaopenwait106")
  : `${guaopenwait}`;
guaopenwait = $.isNode()
...
guaopencard_draw = $.isNode()
  ? process.env.guaopencard_draw106
    ? process.env.guaopencard_draw106
    : guaopencard_draw
  : $.getdata("guaopencard_draw106")
  ? $.getdata("guaopencard_draw106")
  : guaopencard_draw;
guaopencard_draw = $.isNode()
...
async function run() {
  try {
    ...
    if (guaopencard_draw + "" !== "0") {
      ...
      console.log('如需抽奖请设置环境变量[guaopencard_draw106]为"3" 3为次数');
