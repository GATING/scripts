...
!(async () => {
  ...
  authorCodeList = ["4093595bb98c4e1390b10f756addcbf6"];
  $.shareUuid =
...
async function takePostRequest(type) {
  ...
  switch (type) {
    ...
    case "accessLogWithAD":
      ...
      body = `venderId=1000410747&code=99&pin=${encodeURIComponent(
        $.Pin
      )}&activityId=${$.activityId}&pageUrl=${encodeURIComponent(pageurl)}`;
      break;
    case "getOpenCardStatusWithOutSelf":
      url = `${domain}/crmCard/common/coupon/getOpenCardStatusWithOutSelf`;
      body = `venderId=1000410747&activityId=${
        $.activityId
...
function getPostRequest(url, body, method = "POST") {
  ...
  if (url.indexOf("https://lzkjdz-isv.isvjcloud.com") > -1) {
    headers[
      "Referer"
    ] = `https://lzkjdz-isv.isvjcloud.com/m/1000410747/99/2203100041074702/?helpUuid=${$.shareUuid}`;
    headers["Cookie"] = `${
