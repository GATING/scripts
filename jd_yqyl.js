  ...
  if (helpAuthorFlag) {
    try {
      helpAuthorInfo = await getAuthorShareCode(
        "https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/yqyl.json"
      );
    } catch (e) {}
    if (!helpAuthorInfo) {
      helpAuthorInfo = [];
