...
!(async () => {
  ...
  authorCodeList = ["680d8381ff79465b9629f06d23de9354"];
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/march/fashionUnion/activity/${
        $.authorNum
...
async function member() {
  ...
  if ($.token) {
    ...
    if ($.secretPin) {
      ...
      if ($.index === 1) {
        await task(
          "/march/fashionUnion/activityContent",
      ...
      await task(
        "march/fashionUnion/initOpenCard",
