...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku100
    ? process.env.guaopencard_addSku100
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku100")
  ? $.getdata("guaopencard_addSku100")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard100
    ? process.env.guaopencard100
    : `${guaopencard}`
  : $.getdata("guaopencard100")
  ? $.getdata("guaopencard100")
  : `${guaopencard}`;
guaopencard = $.isNode()
  ...
  : `${guaopencard}`;
guaopenwait = $.isNode()
  ? process.env.guaopenwait100
    ? process.env.guaopenwait100
    : `${guaopenwait}`
  : $.getdata("guaopenwait100")
  ? $.getdata("guaopenwait100")
  : `${guaopenwait}`;
guaopenwait = $.isNode()
...
guaopencard_draw = $.isNode()
  ? process.env.guaopencard_draw100
    ? process.env.guaopencard_draw100
    : guaopencard_draw
  : $.getdata("guaopencard_draw100")
  ? $.getdata("guaopencard_draw100")
  : guaopencard_draw;
guaopencard_draw = $.isNode()
...
async function run() {
  try {
    ...
    if (guaopencard_draw + "" !== "0") {
      ...
      console.log('如需抽奖请设置环境变量[guaopencard_draw100]为"3" 3为次数');
