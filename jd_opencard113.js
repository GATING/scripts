...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      authorCodeList = [
        // 'f7d7bcdc4d3e408ea0a584f27f617e4b',
        "4f33bd1ea34e4824867044fc65459a14",
        // '40619ea93a2c42c3ae46a1e37111a7ea',
      ];
      ...
      $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/april/springUnion2/activity/${
        $.authorNum
...
async function member() {
  ...
  if ($.token) {
    ...
    if ($.secretPin) {
      ...
      if ($.index === 1) {
        await task(
          "april/springUnion2/activityContent",
      ...
      await $.wait(1000);
      await task(
        "april/springUnion2/initOpenCard",
