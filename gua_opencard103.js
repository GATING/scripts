...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku103
    ? process.env.guaopencard_addSku103
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku103")
  ? $.getdata("guaopencard_addSku103")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard103
    ? process.env.guaopencard103
    : `${guaopencard}`
  : $.getdata("guaopencard103")
  ? $.getdata("guaopencard103")
  : `${guaopencard}`;
guaopencard = $.isNode()
  ...
  : `${guaopencard}`;
guaopenwait = $.isNode()
  ? process.env.guaopenwait103
    ? process.env.guaopenwait103
    : `${guaopenwait}`
  : $.getdata("guaopenwait103")
  ? $.getdata("guaopenwait103")
  : `${guaopenwait}`;
guaopenwait = $.isNode()
...
guaopencard_draw = $.isNode()
  ? process.env.guaopencard_draw103
    ? process.env.guaopencard_draw103
    : guaopencard_draw
  : $.getdata("guaopencard_draw103")
  ? $.getdata("guaopencard_draw103")
  : guaopencard_draw;
guaopencard_draw = $.isNode()
...
async function run() {
  try {
    ...
    if (guaopencard_draw + "" !== "0") {
      ...
      console.log('如需抽奖请设置环境变量[guaopencard_draw103]为"3" 3为次数');
