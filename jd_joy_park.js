...
function apCashWithDraw(id, poolBaseId, prizeGroupId, prizeBaseId) {
  return new Promise((resolve) => {
    $.post(
      taskPostClientActionUrl(
        `body={"businessSource":"JOY_PARK","base":{"id":${id},"business":"joyPark","poolBaseId":${poolBaseId},"prizeGroupId":${prizeGroupId},"prizeBaseId":${prizeBaseId},"prizeType":4},"linkId":"LsQNxL7iWDlXUs6cFl-AAg"}&_t=${+new Date()}&appid=activities_platform`,
        `apCashWithDraw`
      ),
      async (err, resp, data) => {
        try {
