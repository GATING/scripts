...
opencard_addSku = $.isNode()
  ? process.env.opencard_addSku129
    ? process.env.opencard_addSku129
    : `${opencard_addSku}`
  : $.getdata("opencard_addSku129")
  ? $.getdata("opencard_addSku129")
  : `${opencard_addSku}`;
opencard_addSku = $.isNode()
  ? process.env.opencard_addSku_All
    ? process.env.opencard_addSku_All
    : `${opencard_addSku}`
  : $.getdata("opencard_addSku_All")
  ? $.getdata("opencard_addSku_All")
  : `${opencard_addSku}`;
opencard = $.isNode()
  ? process.env.opencard129
    ? process.env.opencard129
    : `${opencard}`
  : $.getdata("opencard129")
  ? $.getdata("opencard129")
  : `${opencard}`;
opencard = $.isNode()
  ? process.env.opencard_All
    ? process.env.opencard_All
    : `${opencard}`
  : $.getdata("opencard_All")
  ? $.getdata("opencard_All")
  : `${opencard}`;
openwait = $.isNode()
  ? process.env.openwait129
    ? process.env.openwait129
    : `${openwait}`
  : $.getdata("openwait129")
  ? $.getdata("openwait129")
  : `${openwait}`;
openwait = $.isNode()
  ? process.env.openwait_All
    ? process.env.openwait_All
    : `${openwait}`
  : $.getdata("openwait_All")
  ? $.getdata("openwait_All")
  : `${openwait}`;
openwait = parseInt(openwait, 10) || 0;
opencard_draw = $.isNode()
  ? process.env.opencard_draw129
    ? process.env.opencard_draw129
    : opencard_draw
  : $.getdata("opencard_draw129")
  ? $.getdata("opencard_draw129")
  : opencard_draw;
opencard_draw = $.isNode()
  ? process.env.opencard_draw
    ? process.env.opencard_draw
    : opencard_draw
  : $.getdata("opencard_draw")
  ? $.getdata("opencard_draw")
  : opencard_draw;
allMessage = "";
message = "";
...
async function run() {
  try {
    ...
    if (
      ...
      nowTime > new Date("2022/04/27 00:00:00+08:00").getTime()
    ) {
      $.activityEnd = true;
      console.log("活动结束");
      return;
      ...
      if (guaopencard_draw + "" !== "0") {
        ...
        console.log('如需抽奖请设置环境变量[guaopencard_draw133]为"3" 3为次数');
      ...
      if (
        $.drawCardNum &&
        $.compositeCard + "" == "true" &&
        [1, 2, 5].includes($.cardButtonStatus) == true
      ) {
        ...
        for (m = 1; count--; m++) {
          ...
          if (
            $.runFalag == false ||
            $.compositeCardNum > 0 ||
            [2, 3, 5].includes($.cardButtonStatus) == true
          )
            break;
          if (Number(count) <= 0) break;
          if (m >= 10) {
    ...
    console.log(
      `${$.score}值 瓜分:${
        ([2, 3, 5, 6].includes($.cardButtonStatus) == true && "是") || "否"
      }`
    );
...
var _0xodd = "jsjiami.com.v6",
  ...
  _0x3808 = [
    ...
    "w7JewpHDo8K7UQ==",
    "bUxYw6p9wq7CoA0=",
    "w4XDkcKWFQ3DrTcPw4bCrsKxPTfCr8OVEsKhW8K0w5TDscO1NMOxwpDCssOJJR7CksKtw40fWcKGw4t8IDBUworDnMK+woQyIWUeb8OgNsK4w4FoADnDn8KZO8OGwqDCpcOGMA==",
    "w4t9PWF2",
    "wotKwoPDgDU=",
    "csKCwpzDg8OGLg==",
    "FMKhw6V7wpY=",
    ...
    "bgbChw==",
    "wr0INsOYWw==",
    "KHdbRcOhwo5DC2ZfwqYdJsOy",
    "w5fDrgDCvDE=",
    "w5vDrlHCocOiND4OTsOLfcKyJ1HDr8KGwovCmsKH",
    "CsOswrfClgU=",
    "D8KGw45xRMKQNw8B",
    "5Ya+5YG86IGt6YacwoHprY/liZTlibnmu6o=",
    "fsK2w6YRwoHCow==",
    "wpTCkMOUT10=",
    "dRodDD8L",
    "wqc3RiMW",
    "w5/DtcOKDzc=",
    "woJJwrjDvQ==",
    "wozCmcOdX3TClWVcwrbDn8K9MifCuMOj",
    "w5/DpMKY",
    "w6BawpPDg8Kx",
    "wqAFFsO8ew==",
    "b8Odwpk1Ng==",
    ...
    "wpjDmlEeWQ==",
    "dznCvCnCsw==",
    "w4fDlxl8ZcOvwr7DnDkB",
    "G8KYw5p4S8KaOB4MBl7DpCfDmGXCrg==",
    "w7BHe2RXw6wMw6p+acONAsKawrMnS8KJ",
    "LsOSwqPCpwxywptQwoUEYsKLI1bClMOlHMOyHcOYUsKoKg==",
    "w53DssORETRsInTDolHCk8KEwp/CjFdUXQsnJ2nDksKRc8OhwrPDpg==",
    "w6ZIRno+",
    "wrkINMOJUS0=",
    "woPDnV49Uw==",
    "wqjCjsOYw6Bx",
    ...
    "w6RbB2RT",
    "wrltw6DDoSk=",
    "XCEywrk8w4HCujQBwpZPwobCh8Ksw65tw54Xw6jCmF3ClMOwwpbDjn8uwp7DrA7CssK6FHtFG8KuQsOwwrFJSEpJ",
    "wqZww6rDrjI=",
    "wpzDoH81RQ==",
    "U8OTbMOYCw==",
    "R1LCuVVV",
    "bBosGBQ=",
    "wrBLLMOITDNzeE7CpltPw4YhdsOgC8KOwoJ2w4PCrXE=",
    "w7l7w7HCnnELCcKIwooxRQ==",
    "wolWwqHDmhI=",
    "w5lswrInw4hnwqrCqn8MbcOud8KW",
    "w7lrw5U=",
    "w4oBIwnCmnzDjsOWwoJJw6HClmbCi8Kpwqp9wpN7QRgoPcKnwpw0aSImwofCusOUU2w4bw==",
    "jsjiafmi.pKcom.Rvk6IhuPEHLOkpwA==",
  ];
if (
  ((function (_0x1c9da8, _0x3e7572, _0x26c1ce) {
    function _0x130c6d(
      _0x26f2eb,
      _0x2476d3,
      _0x4acd61,
      ...
      (_0x2476d3 = _0x2476d3 >> 0x8), (_0x56382c = "po");
      var _0x5b2b63 = "shift",
        _0x4440f9 = "push",
        _0x10b473 = "‮";
      if (_0x2476d3 < _0x26f2eb) {
        while (--_0x26f2eb) {
          _0x56d6c1 = _0x1c9da8[_0x5b2b63]();
          if (
            _0x2476d3 === _0x26f2eb &&
            _0x10b473 === "‮" &&
            _0x10b473["length"] === 0x1
          ) {
            (_0x2476d3 = _0x56d6c1), (_0x4acd61 = _0x1c9da8[_0x56382c + "p"]());
          } else if (
            _0x2476d3 &&
            _0x4acd61["replace"](/[fpKRkIhuPEHLOkpwA=]/g, "") === _0x2476d3
          ) {
            _0x1c9da8[_0x4440f9](_0x56d6c1);
          }
        }
        _0x1c9da8[_0x4440f9](_0x1c9da8[_0x5b2b63]());
      }
      return 0xdf0c3;
    }
    return (_0x130c6d(++_0x3e7572, _0x26c1ce) >> _0x3e7572) ^ _0x26c1ce;
  })(_0x3808, 0x199, 0x19900),
  _0x3808)
) {
  _0xodd_ = _0x3808["length"] ^ 0x199;
}
function _0x2ad3(_0x36e76f, _0xfd02f8) {
  _0x36e76f = ~~"0x"["concat"](_0x36e76f["slice"](0x1));
  var _0x629bc0 = _0x3808[_0x36e76f];
  if (_0x2ad3["LHEuTg"] === undefined) {
    (function () {
      var _0x17c04b =
      ...
      _0x17c04b["atob"] ||
        (_0x17c04b["atob"] = function (_0x11af30) {
          var _0x50d505 = String(_0x11af30)["replace"](/=+$/, "");
          for (
            var _0x46f72f = 0x0,
              _0x1d9c3d,
              _0x130b85,
              _0x5024d9 = 0x0,
              _0xfa13b5 = "";
            (_0x130b85 = _0x50d505["charAt"](_0x5024d9++));
            ~_0x130b85 &&
            ((_0x1d9c3d =
              _0x46f72f % 0x4 ? _0x1d9c3d * 0x40 + _0x130b85 : _0x130b85),
            _0x46f72f++ % 0x4)
              ? (_0xfa13b5 += String["fromCharCode"](
                  0xff & (_0x1d9c3d >> ((-0x2 * _0x46f72f) & 0x6))
                ))
              : 0x0
          ) {
            _0x130b85 = _0x299d6e["indexOf"](_0x130b85);
          }
          return _0xfa13b5;
        });
    })();
    function _0x429b91(_0x1f1aa6, _0xfd02f8) {
      var _0x4f735c = [],
        _0x3e5132 = 0x0,
        _0x36f354,
        _0x116336 = "",
        _0x5aef7d = "";
      _0x1f1aa6 = atob(_0x1f1aa6);
      for (
        var _0x1e80b2 = 0x0, _0x26d2d9 = _0x1f1aa6["length"];
        _0x1e80b2 < _0x26d2d9;
        _0x1e80b2++
      ) {
        _0x5aef7d +=
          "%" +
          ("00" + _0x1f1aa6["charCodeAt"](_0x1e80b2)["toString"](0x10))[
            "slice"
          ](-0x2);
      }
      _0x1f1aa6 = decodeURIComponent(_0x5aef7d);
      for (var _0x3c532b = 0x0; _0x3c532b < 0x100; _0x3c532b++) {
        _0x4f735c[_0x3c532b] = _0x3c532b;
      }
      for (_0x3c532b = 0x0; _0x3c532b < 0x100; _0x3c532b++) {
        _0x3e5132 =
          (_0x3e5132 +
            _0x4f735c[_0x3c532b] +
            _0xfd02f8["charCodeAt"](_0x3c532b % _0xfd02f8["length"])) %
          0x100;
        _0x36f354 = _0x4f735c[_0x3c532b];
        _0x4f735c[_0x3c532b] = _0x4f735c[_0x3e5132];
        _0x4f735c[_0x3e5132] = _0x36f354;
      }
      _0x3c532b = 0x0;
      _0x3e5132 = 0x0;
      for (var _0x4cf5e5 = 0x0; _0x4cf5e5 < _0x1f1aa6["length"]; _0x4cf5e5++) {
        _0x3c532b = (_0x3c532b + 0x1) % 0x100;
        _0x3e5132 = (_0x3e5132 + _0x4f735c[_0x3c532b]) % 0x100;
        _0x36f354 = _0x4f735c[_0x3c532b];
        _0x4f735c[_0x3c532b] = _0x4f735c[_0x3e5132];
        _0x4f735c[_0x3e5132] = _0x36f354;
        _0x116336 += String["fromCharCode"](
          _0x1f1aa6["charCodeAt"](_0x4cf5e5) ^
            _0x4f735c[(_0x4f735c[_0x3c532b] + _0x4f735c[_0x3e5132]) % 0x100]
        );
      }
      return _0x116336;
    }
    _0x2ad3["OjWKKN"] = _0x429b91;
    _0x2ad3["KPyAQz"] = {};
    _0x2ad3["LHEuTg"] = !![];
  }
  var _0xce03bb = _0x2ad3["KPyAQz"][_0x36e76f];
  if (_0xce03bb === undefined) {
    if (_0x2ad3["UxaUYy"] === undefined) {
      _0x2ad3["UxaUYy"] = !![];
    }
    _0x629bc0 = _0x2ad3["OjWKKN"](_0x629bc0, _0xfd02f8);
    _0x2ad3["KPyAQz"][_0x36e76f] = _0x629bc0;
  } else {
    _0x629bc0 = _0xce03bb;
  }
  return _0x629bc0;
}
async function h5stSign(_0x409d1f, _0xed7385) {
  var _0x2b3a90 = {
    syOaC: function (_0x1bd47c, _0x4d26d8) {
      return _0x1bd47c + _0x4d26d8;
    },
    BKiJq: _0x2ad3("‮0", "MnRQ"),
    jxsmY: _0x2ad3("‮1", "CyLR"),
    klLQE: function (_0x35edf6, _0x3dc600) {
      return _0x35edf6 == _0x3dc600;
    },
    PRNbt: _0x2ad3("‮2", "9e*K"),
    BUIjR: _0x2ad3("‫3", "OsbL"),
    SyvTk: function (_0x28467b, _0x430767) {
      return _0x28467b == _0x430767;
    },
    XnWzU: _0x2ad3("‫4", "y0ky"),
    HKsml: _0x2ad3("‮5", "xM]T"),
    vkVtE: function (_0x5c3ee2, _0x82494d) {
      return _0x5c3ee2 > _0x82494d;
    },
    KKVMl: _0x2ad3("‫6", "bQn]"),
    QiGLW: function (_0x1340a2, _0x55da8a) {
      return _0x1340a2 === _0x55da8a;
    },
    xDvQb: _0x2ad3("‮7", "sMFR"),
    vIhCT: function (_0x1a9abe) {
      return _0x1a9abe();
    },
    tpHoU: function (_0x10708a, _0x4d3a7c) {
      return _0x10708a + _0x4d3a7c;
    },
    rFWmh: function (_0xb4061b, _0x4c38bb) {
      return _0xb4061b + _0x4c38bb;
    },
    veATe: _0x2ad3("‫8", "kjQp"),
    dNpQB: function (_0x3f47da, _0xc82a1b) {
      return _0x3f47da * _0xc82a1b;
    },
    ItxHd: _0x2ad3("‫9", "w8h^"),
    ZCpzx: "jd_shop_member",
    benpU: "body",
    CznEO: _0x2ad3("‮a", "uE!8"),
    CYdEy: "clientVersion",
    ouSky: _0x2ad3("‮b", "HBPc"),
    HWeDr: "functionId",
    eLgED: _0x2ad3("‫c", "aIU!"),
    DhttW: _0x2ad3("‮d", "%1MB"),
    akKdm: _0x2ad3("‮e", "w8h^"),
    qknIs: function (_0x128010, _0x5d37e5) {
      return _0x128010 === _0x5d37e5;
    },
    kwKfM: _0x2ad3("‮f", "PmU]"),
    rZBIt: function (_0x448b3a, _0x37051e) {
      return _0x448b3a(_0x37051e);
    },
  };
  $[_0x2ad3("‫10", "yMg1")] = "";
  if (_0x2b3a90[_0x2ad3("‮11", "CyLR")](_0xed7385, _0x2b3a90["PRNbt"])) {
    $[_0x2ad3("‮12", "tcMF")] = _0x2b3a90[_0x2ad3("‫13", "7@sW")];
  } else if (_0x2b3a90[_0x2ad3("‫14", "aIU!")](_0xed7385, _0x2b3a90["XnWzU"])) {
    $["appId"] = _0x2b3a90[_0x2ad3("‫15", "aOp[")];
  } else {
    _0xed7385 = _0x2b3a90[_0x2ad3("‮16", "FLm&")];
    $["appId"] = _0x2b3a90["BUIjR"];
  }
  if (
    _0x2b3a90[_0x2ad3("‮17", "eN5$")](
      new Date()[_0x2ad3("‫18", "aIU!")](),
      0x18068f79e20
    )
  ) {
    return _0x2b3a90[_0x2ad3("‫19", "HBPc")];
  }
  if (
    _0x2b3a90[_0x2ad3("‮1a", "uE!8")](
      $[_0x2ad3("‮1b", "w^ja")][_0x2ad3("‫1c", "ZRO5")](_0x2b3a90["xDvQb"]),
      -0x1
    )
  )
    return _0x2b3a90[_0x2ad3("‫1d", "OsbL")];
  await _0x2b3a90["vIhCT"](_0x1b9be8);
  _0x409d1f = $[_0x2ad3("‫1e", "RolH")](_0x409d1f, _0x409d1f);
  let _0x5dde8f = _0x2b3a90["tpHoU"](
    _0x2b3a90[_0x2ad3("‮1f", "MnRQ")](
      _0x2b3a90[_0x2ad3("‫20", "PmU]")](
        _0x2b3a90[_0x2ad3("‮21", "eN5$")],
        Date["now"]()
      ),
      "_"
    ),
    Math["ceil"](_0x2b3a90[_0x2ad3("‮22", "HBPc")](0x186a0, Math["random"]()))
  );
  let _0x556fc3 = [
    { key: _0x2b3a90[_0x2ad3("‮23", "HBPc")], value: _0x2b3a90["ZCpzx"] },
    {
      key: _0x2b3a90[_0x2ad3("‫24", "7@sW")],
      value: $["CryptoJS"]
        [_0x2ad3("‫25", "w8h^")](
          $[_0x2ad3("‮26", "FLm&")](_0x409d1f, _0x409d1f)
        )
        [_0x2ad3("‮27", "k$8n")](),
    },
    { key: _0x2b3a90[_0x2ad3("‮28", "4u$$")], value: "H5" },
    { key: _0x2b3a90["CYdEy"], value: _0x2b3a90[_0x2ad3("‫29", "iH*s")] },
    { key: _0x2b3a90[_0x2ad3("‮2a", "]Ymx")], value: _0xed7385 },
    { key: _0x2b3a90["eLgED"], value: _0x5dde8f },
  ];
  let _0x4fad8e = _0x556fc3[_0x2ad3("‫2b", "RolH")](function (_0x1e50ee) {
    return _0x2b3a90["syOaC"](
      _0x2b3a90[_0x2ad3("‫2c", "w8h^")](
        _0x1e50ee[_0x2b3a90[_0x2ad3("‮2d", "7@sW")]],
        ":"
      ),
      _0x1e50ee[_0x2b3a90["jxsmY"]]
    );
  })[_0x2b3a90["DhttW"]]("&");
  let _0x3ba42a = Date["now"]();
  let _0x5e2eea = "";
  let _0xe6d0ed = $[_0x2ad3("‫2e", "k$8n")](
    _0x2b3a90[_0x2ad3("‫2f", "fh)c")],
    _0x3ba42a
  );
  _0x5e2eea = $[_0x2ad3("‮30", "TT63")](
    $["token"],
    $["fp"][_0x2ad3("‮31", "Xpz^")](),
    _0xe6d0ed["toString"](),
    $[_0x2ad3("‮32", "0hkr")][_0x2ad3("‫33", "PmU]")](),
    $[_0x2ad3("‮34", "!1ae")]
  )["toString"]();
  if (
    _0x2b3a90["qknIs"](
      $["name"][_0x2ad3("‫35", "]Ymx")](_0x2b3a90["xDvQb"]),
      -0x1
    )
  )
    return _0x2b3a90[_0x2ad3("‮36", "7@sW")];
  const _0x1acda4 = $["CryptoJS"]
    ["HmacSHA256"](_0x4fad8e, _0x5e2eea[_0x2ad3("‫37", "CyLR")]())
    [_0x2ad3("‫38", "!1ae")]();
  let _0x5341e3 = [
    ""["concat"](_0xe6d0ed[_0x2ad3("‮39", "PQqr")]()),
    ""[_0x2ad3("‮3a", "]Ymx")]($["fp"]["toString"]()),
    ""[_0x2ad3("‮3b", "k$8n")]($["appId"]["toString"]()),
    ""["concat"]($[_0x2ad3("‫3c", "k$8n")]),
    ""[_0x2ad3("‮3d", "@Bht")](_0x1acda4),
    _0x2b3a90[_0x2ad3("‮3e", "CyLR")],
    ""[_0x2ad3("‮3f", "MYv(")](_0x3ba42a),
  ]["join"](";");
  if (
    _0x2b3a90[_0x2ad3("‮40", "RolH")](
      $[_0x2ad3("‫41", "T0Q[")][_0x2ad3("‫1c", "ZRO5")](_0x2b3a90["xDvQb"]),
      -0x1
    )
  )
    return _0x2b3a90[_0x2ad3("‮42", "k3pO")];
  return _0x2b3a90["rFWmh"](
    _0x2b3a90[_0x2ad3("‫43", "MnRQ")](encodeURIComponent, _0x5341e3),
    "&jsonp=" + _0x5dde8f
  );
}
async function _0x1b9be8() {
  var _0x1d1363 = {
    MhzNT: function (_0x2b2d98) {
      return _0x2b2d98();
    },
    quTnE: _0x2ad3("‫44", "!1ae"),
    DoPYR: function (_0x431e82, _0x198eef) {
      return _0x431e82 | _0x198eef;
    },
    tKMgK: function (_0x165249, _0x167809) {
      return _0x165249 * _0x167809;
    },
    PLYnf: function (_0x484961, _0x2e3b87) {
      return _0x484961 + _0x2e3b87;
    },
    RtocX: function (_0x479027, _0x5027c6) {
      return _0x479027(_0x5027c6);
    },
    DDplX: function (_0x36f5a4, _0x1c2472) {
      return _0x36f5a4 == _0x1c2472;
    },
    LcJRD: function (_0x5d1ae2, _0x5ae875) {
      return _0x5d1ae2 < _0x5ae875;
    },
    KaTZe: function (_0x1c72a7, _0xbb6262) {
      return _0x1c72a7 + _0xbb6262;
    },
    Gzlpc: function (_0x36b46f, _0xd661cb) {
      return _0x36b46f + _0xd661cb;
    },
    ocMef: function (_0x4e7030, _0x2eab4f) {
      return _0x4e7030 + _0x2eab4f;
    },
    zBsiu: function (_0x13893c, _0x53a5eb) {
      return _0x13893c + _0x53a5eb;
    },
    mDAyK: function (_0x547441, _0x5cb5fc) {
      return _0x547441(_0x5cb5fc);
    },
    BDuts: function (_0x1737b8, _0x122786) {
      return _0x1737b8 - _0x122786;
    },
    Plrik: function (_0xac1a2d, _0x331d5b) {
      return _0xac1a2d + _0x331d5b;
    },
    Oqxfp: _0x2ad3("‫45", "bQn]"),
    mOxxw: _0x2ad3("‫46", "fj5a"),
    MXpAe: _0x2ad3("‮47", "w^ja"),
    zlXqE: _0x2ad3("‫48", "aIU!"),
    obrWV: "https://shopmember.m.jd.com/",
  };
  var _0x5d8b76 = _0x1d1363[_0x2ad3("‫49", "fj5a")],
    _0x57500a = "",
    _0x3c867e = _0x5d8b76,
    _0x195f09 = _0x1d1363["DoPYR"](
      _0x1d1363["tKMgK"](Math[_0x2ad3("‮4a", "CyLR")](), 0xa),
      0x0
    );
  do {
    var _0x5b173e = _0x1d1363[_0x2ad3("‫4b", "k3pO")](
      _0x1d1363["RtocX"](_0x2ba74d, { size: 0x1, customDict: _0x3c867e }),
      ""
    );
    if (
      _0x1d1363[_0x2ad3("‫4c", "PmU]")](
        _0x57500a[_0x2ad3("‫4d", "MnRQ")](_0x5b173e),
        -0x1
      )
    )
      _0x57500a += _0x5b173e;
  } while (_0x1d1363["LcJRD"](_0x57500a[_0x2ad3("‫4e", "yMb8")], 0x3));
  for (let _0x192c5e of _0x57500a["slice"]())
    _0x3c867e = _0x3c867e[_0x2ad3("‫4f", "k$8n")](_0x192c5e, "");
  $["fp"] = _0x1d1363[_0x2ad3("‮50", "MYv(")](
    _0x1d1363[_0x2ad3("‫51", "@4Br")](
      _0x1d1363[_0x2ad3("‮52", "FLm&")](
        _0x1d1363[_0x2ad3("‫53", "!1ae")](
          _0x1d1363["zBsiu"](
            _0x1d1363[_0x2ad3("‫54", "sMFR")](_0x2ba74d, {
              size: _0x195f09,
              customDict: _0x3c867e,
            }),
            ""
          ),
          _0x57500a
        ),
        _0x1d1363["mDAyK"](_0x2ba74d, {
          size: _0x1d1363[_0x2ad3("‮55", "HBPc")](
            _0x1d1363["BDuts"](
              0xe,
              _0x1d1363[_0x2ad3("‫56", "Efy&")](_0x195f09, 0x3)
            ),
            0x1
          ),
          customDict: _0x3c867e,
  ...
  let _0x3640fd = {
    url: _0x2ad3("‮57", "@Bht"),
    headers: {
      Accept: _0x1d1363[_0x2ad3("‫58", "Efy&")],
      "Content-Type": _0x1d1363[_0x2ad3("‫59", "k3pO")],
      "Accept-Encoding": _0x1d1363[_0x2ad3("‫5a", "RolH")],
      "Accept-Language": _0x1d1363[_0x2ad3("‮5b", "ZRO5")],
      Origin: _0x1d1363[_0x2ad3("‫5c", "uE!8")],
      Referer: _0x1d1363["obrWV"],
      "user-agent": $["UA"],
    },
    body:
      _0x2ad3("‫5d", "CyLR") +
  ...
  return new Promise(async (_0x3afc21) => {
    var _0x4b5775 = {
      DeYGp: function (_0x5c5891) {
        return _0x1d1363["MhzNT"](_0x5c5891);
      },
    };
    $["post"](_0x3640fd, (_0xc9a589, _0x3630ff, _0x13e7e0) => {
      try {
        const {
          ret,
          msg,
          data: { result } = {},
        } = $[_0x2ad3("‫63", "xM]T")](_0x13e7e0, _0x13e7e0);
        $[_0x2ad3("‫64", "uE!8")] = result["tk"];
        $[_0x2ad3("‫65", "tcMF")] = new Function(
          _0x2ad3("‫66", "uE!8") + result[_0x2ad3("‮67", "Efy&")]
        )();
      } catch (_0xa1659) {
        $[_0x2ad3("‮68", "Efy&")](_0xa1659, _0x3630ff);
      } finally {
        _0x4b5775[_0x2ad3("‮69", "kjQp")](_0x3afc21);
      }
    });
  });
}
function _0x2ba74d() {
  var _0x4331cb = {
    UdIlP: function (_0x187f0f, _0x11bbb2) {
      return _0x187f0f === _0x11bbb2;
    },
    clRSC: function (_0x2cc4fc, _0x132f03) {
      return _0x2cc4fc < _0x132f03;
    },
    LiOdJ: function (_0x1eb19d, _0x508c33) {
      return _0x1eb19d !== _0x508c33;
    },
    FSuSf: function (_0x188019, _0x14b1db) {
      return _0x188019 === _0x14b1db;
    },
    xMfFa: _0x2ad3("‮6a", "aIU!"),
    FhclC: function (_0x856e39, _0x37c8e9) {
      return _0x856e39 == _0x37c8e9;
    },
    AavfV: _0x2ad3("‮6b", "yMg1"),
    kNdAC: _0x2ad3("‮6c", "Czev"),
    BhcFr: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",
    qyUmk: "max",
    pSsBc: _0x2ad3("‫6d", "w8h^"),
    VqWYh: "0123456789",
    NrdxO: function (_0xb25e49, _0x5d1729) {
      return _0xb25e49 === _0x5d1729;
    },
    vsiwM: "充值能量\x20魅力加满",
    Xywij: function (_0x58fd96, _0x999aaf) {
      return _0x58fd96 | _0x999aaf;
    },
    MEejf: function (_0x448c60, _0x1b2640) {
      return _0x448c60 * _0x1b2640;
    },
    jMIVz: function (_0x21a7bd, _0x4a446e) {
      return _0x21a7bd > _0x4a446e;
    },
  };
  var _0x85534,
    _0x15e03c,
    _0x3b45fc = _0x4331cb[_0x2ad3("‫6e", "HBPc")](
      void 0x0,
      (_0x565a5a = (_0x15e03c =
        _0x4331cb[_0x2ad3("‮6f", "%1MB")](
          0x0,
          arguments[_0x2ad3("‫70", "fh)c")]
        ) && _0x4331cb[_0x2ad3("‮71", "aOp[")](void 0x0, arguments[0x0])
          ? arguments[0x0]
          : {})[_0x2ad3("‫72", "uE!8")])
    )
      ? 0xa
      : _0x565a5a,
    _0x565a5a = _0x4331cb[_0x2ad3("‮73", "fh)c")](
      void 0x0,
      (_0x565a5a = _0x15e03c[_0x2ad3("‫74", "tcMF")])
    )
      ? _0x4331cb[_0x2ad3("‮75", "lddD")]
      : _0x565a5a,
    _0x4e0c8f = "";
  if (
    (_0x15e03c = _0x15e03c[_0x2ad3("‮76", "9e*K")]) &&
    _0x4331cb[_0x2ad3("‮77", "aOp[")](
      _0x4331cb[_0x2ad3("‮78", "MYv(")],
      typeof _0x15e03c
    )
  )
    _0x85534 = _0x15e03c;
    ...
    switch (_0x565a5a) {
      case _0x4331cb["kNdAC"]:
        _0x85534 = _0x4331cb["BhcFr"];
        break;
      case _0x4331cb[_0x2ad3("‮79", "k3pO")]:
        _0x85534 = _0x4331cb["pSsBc"];
        break;
      case _0x4331cb[_0x2ad3("‮7a", "Efy&")]:
      default:
        _0x85534 = _0x4331cb[_0x2ad3("‮7b", "adP3")];
    }
  if (_0x4331cb["NrdxO"]($["name"]["indexOf"](_0x4331cb["vsiwM"]), -0x1))
    return "1";
  for (; _0x3b45fc--; )
    _0x4e0c8f +=
      _0x85534[
        _0x4331cb["Xywij"](
          _0x4331cb["MEejf"](
            Math[_0x2ad3("‫7c", "@4Br")](),
            _0x85534[_0x2ad3("‮7d", "%hBU")]
          ),
          0x0
        )
      ];
  if (
    _0x4331cb[_0x2ad3("‫7e", "MnRQ")](new Date()["getTime"](), 0x18068f79e20)
  ) {
    return "1";
  }
  return _0x4e0c8f;
