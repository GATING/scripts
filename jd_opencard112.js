...
guaopencard_addSku = $.isNode()
  ? process.env.guaopencard_addSku127
    ? process.env.guaopencard_addSku127
    : `${guaopencard_addSku}`
  : $.getdata("guaopencard_addSku127")
  ? $.getdata("guaopencard_addSku127")
  : `${guaopencard_addSku}`;
guaopencard_addSku = $.isNode()
  ...
  : `${guaopencard_addSku}`;
guaopencard = $.isNode()
  ? process.env.guaopencard127
    ? process.env.guaopencard127
    : `${guaopencard}`
  : $.getdata("guaopencard127")
  ? $.getdata("guaopencard127")
  : `${guaopencard}`;
guaopencard = $.isNode()
  ...
  : `${guaopencard}`;
guaopenwait = $.isNode()
  ? process.env.guaopenwait127
    ? process.env.guaopenwait127
    : `${guaopenwait}`
  : $.getdata("guaopenwait127")
  ? $.getdata("guaopenwait127")
  : `${guaopenwait}`;
guaopenwait = $.isNode()
...
guaopencard_draw = $.isNode()
  ? process.env.guaopencard_draw127
    ? process.env.guaopencard_draw127
    : guaopencard_draw
  : $.getdata("guaopencard_draw127")
  ? $.getdata("guaopencard_draw127")
  : guaopencard_draw;
guaopencard_draw = $.isNode()
...
!(async () => {
  ...
  $.shareUuid = "ada82c3b225d4bb08a6a6a1fca214807";
  console.log(
...
async function run() {
  try {
    ...
    if (guaopencard_draw + "" !== "0") {
      ...
      console.log('如需抽奖请设置环境变量[guaopencard_draw127]为"3" 3为次数');
...
var _0xodT = "jsjiami.com.v6",
  ...
  _0x5547 = [
    ...
    "aQ0h",
    "w7vCp8OZfUM=",
    "w5DDnnLDlSzCnsOpOgvDvA==",
    "LnTDghnDgMOLw63Dp2HDtkHDvH1bw6sbwrQ=",
    "w7fDuQzChMK1QynDoMOYw4bCr8Kewrl9VMOSLcKtZsKNw5Qswpg=",
    "ZinDjzTDksK1wo7CvsOBwpkkw7zDr8OUck5zwpjDt114YhVdwqYtw54N",
    "wpsZw7lZwoxpw77CkMOcQU4TX2gWNksaw4hgScO8JxQtw5zDuCrCmsOpw5woIMOawonCv8O2N8KwEgrCjX8zw59hXCIwwq9ARRfDiAXDrsKjHirDjMK+SVTCv8OSw4LCs3JFb3ZxF8Ozwp9XwqzCqGpHUcK5LsKowqR3wqs3X8O1w7ZPBDBHb8Kiwr7CvsKFw5glw5dGEsO5w6JiBFl1C8Ktw6UwSsObwrHDgcKF",
    "wr7Dh8OmwpLCpA==",
    "bsKyw6hxTg==",
    "e8OUPzNrAg==",
    "w4cfGcOyw6U=",
    ...
    "ccOWwo3DuGA=",
    "wr1Tw5bCtT4=",
    "I8OFGGTDgcKYZcOdw63DlznDlcKDM8OvScK9PcOQw5fCsiQ5w7/CqhFGwoU+wrwhcmLCoDjDnHZ6dTzDjMK7w5Ek",
    "wrjCjCrCqX0=",
    "w7/CosKswqNL",
    "L3EOKMKz",
    "wpHCnAjCncKx",
    "w4zDhHXCkcKt",
    "w7PCosKzwpRt",
    "MizDnQzCnsKYw6DDrWnCuBrCqitZw7tbw6rCiy1WDcOkwrs=",
    "w5LCoUA2wqQ=",
    "wofCjg3CncKT",
    "AhAtw7tA",
    "KMOTw5fDvzg=",
    ...
    "w5HDp8Knwr0B",
    "KcO9WcOkwpc=",
    "5LqT5LmQ6LaY5bmS5a6c6La16LSm",
    "w7HCuBFbMg==",
    "XMOYTcOM",
    "w5nDgXLDiCg=",
    "wp/DmcOLwqXCt8Kcw4/CrmjDvw==",
    "b8K0asKAw5c/ZcKGVHcEfMKXRg==",
    "AMO1OMO/X8Odwok=",
    "worDgsOUwoXDgg==",
    "bMOWwpXDr0Y=",
    "Lgo2w5DDgQ==",
    ...
    "wobDgsO+wpvDhg==",
    "c8OES8Ocwos=",
    "jsjgiVaQmwiQTN.comY.qvY6Q==",
  ];
if (
  ((function (_0x4a6f88, _0xf1844a, _0x29c637) {
    function _0x5c37dd(
      _0x1df0a8,
      _0x36583c,
      _0x4fc579,
      ...
      (_0x36583c = _0x36583c >> 0x8), (_0xe91899 = "po");
      var _0x75f46a = "shift",
        _0x27ce2a = "push",
        _0x5f1ca6 = "‮";
      if (_0x36583c < _0x1df0a8) {
        while (--_0x1df0a8) {
          _0x32cb32 = _0x4a6f88[_0x75f46a]();
          if (
            _0x36583c === _0x1df0a8 &&
            _0x5f1ca6 === "‮" &&
            _0x5f1ca6["length"] === 0x1
          ) {
            (_0x36583c = _0x32cb32), (_0x4fc579 = _0x4a6f88[_0xe91899 + "p"]());
          } else if (
            _0x36583c &&
            _0x4fc579["replace"](/[gVQwQTNYqYQ=]/g, "") === _0x36583c
          ) {
            _0x4a6f88[_0x27ce2a](_0x32cb32);
          }
        }
        _0x4a6f88[_0x27ce2a](_0x4a6f88[_0x75f46a]());
      }
      return 0xdcd75;
    }
    return (_0x5c37dd(++_0xf1844a, _0x29c637) >> _0xf1844a) ^ _0x29c637;
  })(_0x5547, 0x76, 0x7600),
  _0x5547)
) {
  _0xodT_ = _0x5547["length"] ^ 0x76;
}
function _0x1ddd(_0x1e2e67, _0x40f66e) {
  _0x1e2e67 = ~~"0x"["concat"](_0x1e2e67["slice"](0x1));
  var _0xdefb93 = _0x5547[_0x1e2e67];
  if (_0x1ddd["vTCLsE"] === undefined) {
    (function () {
      var _0x3c83c3 =
      ...
      _0x3c83c3["atob"] ||
        (_0x3c83c3["atob"] = function (_0x26f393) {
          var _0x449b7a = String(_0x26f393)["replace"](/=+$/, "");
          for (
            var _0x12c236 = 0x0,
              _0x42a29e,
              _0x57fed8,
              _0x4ce5ce = 0x0,
              _0x26fc42 = "";
            (_0x57fed8 = _0x449b7a["charAt"](_0x4ce5ce++));
            ~_0x57fed8 &&
            ((_0x42a29e =
              _0x12c236 % 0x4 ? _0x42a29e * 0x40 + _0x57fed8 : _0x57fed8),
            _0x12c236++ % 0x4)
              ? (_0x26fc42 += String["fromCharCode"](
                  0xff & (_0x42a29e >> ((-0x2 * _0x12c236) & 0x6))
                ))
              : 0x0
          ) {
            _0x57fed8 = _0x4ce826["indexOf"](_0x57fed8);
          }
          return _0x26fc42;
        });
    })();
    function _0x5bc8ed(_0x479f61, _0x40f66e) {
      var _0x41c701 = [],
        _0x150d36 = 0x0,
        _0x236273,
        _0x427f25 = "",
        _0x1f2f09 = "";
      _0x479f61 = atob(_0x479f61);
      for (
        var _0x13e34e = 0x0, _0x3448af = _0x479f61["length"];
        _0x13e34e < _0x3448af;
        _0x13e34e++
      ) {
        _0x1f2f09 +=
          "%" +
          ("00" + _0x479f61["charCodeAt"](_0x13e34e)["toString"](0x10))[
            "slice"
          ](-0x2);
      }
      _0x479f61 = decodeURIComponent(_0x1f2f09);
      for (var _0x28a187 = 0x0; _0x28a187 < 0x100; _0x28a187++) {
        _0x41c701[_0x28a187] = _0x28a187;
      }
      for (_0x28a187 = 0x0; _0x28a187 < 0x100; _0x28a187++) {
        _0x150d36 =
          (_0x150d36 +
            _0x41c701[_0x28a187] +
            _0x40f66e["charCodeAt"](_0x28a187 % _0x40f66e["length"])) %
          0x100;
        _0x236273 = _0x41c701[_0x28a187];
        _0x41c701[_0x28a187] = _0x41c701[_0x150d36];
        _0x41c701[_0x150d36] = _0x236273;
      }
      _0x28a187 = 0x0;
      _0x150d36 = 0x0;
      for (var _0x37c6b0 = 0x0; _0x37c6b0 < _0x479f61["length"]; _0x37c6b0++) {
        _0x28a187 = (_0x28a187 + 0x1) % 0x100;
        _0x150d36 = (_0x150d36 + _0x41c701[_0x28a187]) % 0x100;
        _0x236273 = _0x41c701[_0x28a187];
        _0x41c701[_0x28a187] = _0x41c701[_0x150d36];
        _0x41c701[_0x150d36] = _0x236273;
        _0x427f25 += String["fromCharCode"](
          _0x479f61["charCodeAt"](_0x37c6b0) ^
            _0x41c701[(_0x41c701[_0x28a187] + _0x41c701[_0x150d36]) % 0x100]
        );
      }
      return _0x427f25;
    }
    _0x1ddd["aKlrbT"] = _0x5bc8ed;
    _0x1ddd["AnsTsu"] = {};
    _0x1ddd["vTCLsE"] = !![];
  }
  var _0xf47cd6 = _0x1ddd["AnsTsu"][_0x1e2e67];
  if (_0xf47cd6 === undefined) {
    if (_0x1ddd["iLHXRw"] === undefined) {
      _0x1ddd["iLHXRw"] = !![];
    }
    _0xdefb93 = _0x1ddd["aKlrbT"](_0xdefb93, _0x40f66e);
    _0x1ddd["AnsTsu"][_0x1e2e67] = _0xdefb93;
  } else {
    _0xdefb93 = _0xf47cd6;
  }
  return _0xdefb93;
}
async function _0x26c884(_0x30f5e0) {
  var _0x51aafa = {
    dHFkm: function (_0x154fdf) {
      return _0x154fdf();
    },
    jNWWn: function (_0x93a56b, _0x28831a) {
      return _0x93a56b + _0x28831a;
    },
    FYDuc: function (_0x292379, _0x360dd1) {
      return _0x292379 + _0x360dd1;
    },
    avjkg: _0x1ddd("‮0", "KMoy"),
    urZfW: _0x1ddd("‫1", "u&v]"),
    uuiRn: function (_0xfc7d69, _0x5b7117) {
      return _0xfc7d69 > _0x5b7117;
    },
    JYnkg: function (_0x4aafba, _0xf5fff4) {
      return _0x4aafba === _0xf5fff4;
    },
    xTMMP: _0x1ddd("‮2", "#R^r"),
    NsFoQ: _0x1ddd("‫3", "KMoy"),
    CUdZv: "undefined",
    vvPTH: _0x1ddd("‮4", "lNRz"),
    gcUnm: _0x1ddd("‫5", "]9E6"),
    MfhUB: "jd_shop_member",
    qYSpj: _0x1ddd("‮6", "#oK6"),
    FkrCi: "client",
    mbgfL: "clientVersion",
    FbaMy: _0x1ddd("‮7", "YlvL"),
    vFjuw: _0x1ddd("‮8", "^2DS"),
    gWuSK: _0x1ddd("‮9", "Mr7]"),
    mynOu: "jsonp",
    rJQcY: function (_0x5e7991, _0x57ef0d) {
      return _0x5e7991 + _0x57ef0d;
    },
    MsbiO: "jsonp_",
    Czloe: function (_0x1fbba1, _0x1a9f28) {
      return _0x1fbba1 * _0x1a9f28;
    },
    OXMTh: "join",
    nQVmM: "yyyyMMddHHmmssS",
    NvEuC: "8adfb",
    NhtXQ: "3.0",
  };
  if (_0x51aafa["uuiRn"](new Date()[_0x1ddd("‮a", "PYw&")](), 0x18021b2af00)) {
    if (
      _0x51aafa[_0x1ddd("‫b", "jF4L")](
        _0x51aafa[_0x1ddd("‫c", "LONP")],
        _0x51aafa[_0x1ddd("‫d", "QJgh")]
      )
    ) {
      _0x51aafa[_0x1ddd("‮e", "KMoy")](resolve);
    } else {
      return _0x51aafa["CUdZv"];
    }
  }
  if (
    _0x51aafa[_0x1ddd("‫f", "lyrP")](
      $[_0x1ddd("‫10", "Mted")][_0x1ddd("‫11", "[SPd")](_0x51aafa["vvPTH"]),
      -0x1
    )
  )
    return _0x51aafa["CUdZv"];
  await _0x51aafa["dHFkm"](_0x1165f8);
  _0x30f5e0 = $["toObj"](_0x30f5e0, _0x30f5e0);
  let _0x564740 = [
    {
      key: _0x51aafa[_0x1ddd("‮12", "!UFB")],
      value: _0x51aafa[_0x1ddd("‫13", "LONP")],
    },
    {
      key: _0x51aafa[_0x1ddd("‫14", "E35d")],
      value: $[_0x1ddd("‫15", "o961")]
        ["SHA256"]($[_0x1ddd("‮16", "KMoy")](_0x30f5e0, _0x30f5e0))
        ["toString"](),
    },
    { key: _0x51aafa[_0x1ddd("‮17", "Yi!%")], value: "H5" },
    {
      key: _0x51aafa[_0x1ddd("‫18", "pPO$")],
      value: _0x51aafa[_0x1ddd("‮19", "lNRz")],
    },
    {
      key: _0x51aafa[_0x1ddd("‫1a", "lNRz")],
      value: _0x51aafa[_0x1ddd("‫1b", "HG5O")],
    },
    {
      key: _0x51aafa["mynOu"],
      value: _0x51aafa[_0x1ddd("‮1c", "lyrP")](
        _0x51aafa[_0x1ddd("‮1d", "jF4L")](
          _0x51aafa["rJQcY"](
            _0x51aafa[_0x1ddd("‮1e", "#oK6")],
            Date[_0x1ddd("‮1f", "QJgh")]()
          ),
          "_"
        ),
        Math["ceil"](
          _0x51aafa[_0x1ddd("‮20", "LQ(d")](
            0x186a0,
            Math[_0x1ddd("‮21", "LQ(d")]()
          )
        )
      ),
    },
  ];
  let _0x3c32e3 = _0x564740[_0x1ddd("‫22", "fwTe")](function (_0x520c82) {
    return _0x51aafa[_0x1ddd("‮23", "#R^r")](
      _0x51aafa["FYDuc"](_0x520c82[_0x51aafa["avjkg"]], ":"),
      _0x520c82[_0x51aafa[_0x1ddd("‮24", "o961")]]
    );
  })[_0x51aafa[_0x1ddd("‫25", "YlvL")]]("&");
  let _0x267711 = Date[_0x1ddd("‮26", "i$U2")]();
  let _0x580e8a = "";
  let _0x85bb02 = $[_0x1ddd("‫27", "t&pr")](
    _0x51aafa[_0x1ddd("‮28", "PYw&")],
    _0x267711
  );
  _0x580e8a = $[_0x1ddd("‫29", "FnU^")](
    $["token"],
    $["fp"][_0x1ddd("‫2a", "pg08")](),
    _0x85bb02["toString"](),
    _0x51aafa["NvEuC"][_0x1ddd("‮2b", "Mted")](),
    $["CryptoJS"]
  )[_0x1ddd("‮2c", "KMoy")]();
  if (
    _0x51aafa[_0x1ddd("‮2d", "PYw&")](
      $[_0x1ddd("‮2e", "]9E6")][_0x1ddd("‫2f", "FnU^")](
        _0x51aafa[_0x1ddd("‮30", "MwfJ")]
      ),
      -0x1
    )
  )
    return _0x51aafa[_0x1ddd("‫31", "f9Zz")];
  const _0x18b627 = $[_0x1ddd("‮32", ")aDT")]
    [_0x1ddd("‮33", "6V4W")](_0x3c32e3, _0x580e8a[_0x1ddd("‮34", "HG5O")]())
    ["toString"]();
  let _0x1e68a1 = [
    ""[_0x1ddd("‫35", ")aDT")](_0x85bb02["toString"]()),
    ""[_0x1ddd("‫36", "y4&8")]($["fp"][_0x1ddd("‮37", "PmwU")]()),
    ""[_0x1ddd("‮38", "Mr7]")](
      _0x51aafa[_0x1ddd("‫39", "!UFB")][_0x1ddd("‮3a", "pPO$")]()
    ),
    ""[_0x1ddd("‮3b", "fwTe")]($[_0x1ddd("‫3c", "d3kj")]),
    ""[_0x1ddd("‫3d", "]9E6")](_0x18b627),
    _0x51aafa[_0x1ddd("‮3e", "KMoy")],
    ""[_0x1ddd("‫3f", "QJgh")](_0x267711),
  ][_0x1ddd("‮40", "d3kj")](";");
  if (
    _0x51aafa[_0x1ddd("‫41", "PmwU")](
      $[_0x1ddd("‮42", "!UFB")][_0x1ddd("‫43", "o961")](
        _0x51aafa[_0x1ddd("‫44", "E35d")]
      ),
      -0x1
    )
  )
...
async function _0x1165f8() {
  var _0x315316 = {
    DoSDw: function (_0x49a0e2, _0x1125a9) {
      return _0x49a0e2 + _0x1125a9;
    },
    yTozb: _0x1ddd("‮45", "4E(x"),
    Ftmdo: "value",
    pCsmG: function (_0x5116a9, _0x4a2af2) {
      return _0x5116a9(_0x4a2af2);
    },
    Fdpac: function (_0x265cb8, _0x1c452a) {
      return _0x265cb8 == _0x1c452a;
    },
    upqXg: function (_0x9aa073, _0x5be16b) {
      return _0x9aa073 !== _0x5be16b;
    },
    SwqXe: "HmpYG",
    FnpQv: function (_0x4f7f64, _0x10bd66) {
      return _0x4f7f64 !== _0x10bd66;
    },
    zOSVO: "olznd",
    QDmOi: function (_0x55fb5e) {
      return _0x55fb5e();
    },
    tbAyO: function (_0x558e52, _0x4a844b) {
      return _0x558e52 === _0x4a844b;
    },
    QraZu: "WpIlL",
    iQYnN: _0x1ddd("‫46", "H#OK"),
    GkCTg: _0x1ddd("‫47", "YlvL"),
    tGNOz: function (_0x57a23d, _0x250041) {
      return _0x57a23d | _0x250041;
    },
    XMhrF: function (_0x26d975, _0x5c8dde) {
      return _0x26d975 * _0x5c8dde;
    },
    JXnXe: function (_0x20069c, _0x5c5140) {
      return _0x20069c + _0x5c5140;
    },
    bqXDo: function (_0x168aa6, _0x20692c) {
      return _0x168aa6 == _0x20692c;
    },
    rdhJJ: function (_0x1541a9, _0x23f01d) {
      return _0x1541a9 < _0x23f01d;
    },
    hVrAy: function (_0x244e7f, _0xe2213b) {
      return _0x244e7f + _0xe2213b;
    },
    eTUZv: function (_0x5cb63e, _0x4eb46f) {
      return _0x5cb63e(_0x4eb46f);
    },
    DsudJ: function (_0x9f8238, _0x303ef0) {
      return _0x9f8238 - _0x303ef0;
    },
    zEEFY: function (_0x16017b, _0x52d49a) {
      return _0x16017b + _0x52d49a;
    },
    XcjOe: "application/json",
    fwudm: _0x1ddd("‮48", "PmwU"),
    PvuaA: _0x1ddd("‫49", "[SPd"),
    AUTVV: "https://shopmember.m.jd.com",
    nThgL: _0x1ddd("‮4a", "uR^("),
    TcuxC: _0x1ddd("‮4b", "LQ(d"),
  };
  var _0x5a2a1e = "",
    _0x250a16 = _0x315316[_0x1ddd("‮4c", "^2DS")],
    _0x2622d9 = _0x250a16,
    _0x206afa = _0x315316[_0x1ddd("‫4d", "gZdj")](
      _0x315316["XMhrF"](Math[_0x1ddd("‫4e", "lyrP")](), 0xa),
      0x0
    );
  do {
    ss = _0x315316[_0x1ddd("‮4f", ")Ode")](
      _0x315316[_0x1ddd("‫50", "fwTe")](_0x546cf9, {
        size: 0x1,
        customDict: _0x250a16,
      }),
      ""
    );
    if (_0x315316["bqXDo"](_0x5a2a1e["indexOf"](ss), -0x1)) _0x5a2a1e += ss;
  } while (
    _0x315316[_0x1ddd("‮51", "PmwU")](_0x5a2a1e[_0x1ddd("‮52", "E35d")], 0x3)
  );
  for (let _0x1c8dfd of _0x5a2a1e["slice"]())
    _0x2622d9 = _0x2622d9[_0x1ddd("‫53", "PmwU")](_0x1c8dfd, "");
  $["fp"] = _0x315316["JXnXe"](
    _0x315316[_0x1ddd("‮54", "Mted")](
      _0x315316[_0x1ddd("‫55", "uR^(")](
        _0x315316[_0x1ddd("‮56", "FnU^")](
          _0x315316[_0x1ddd("‮57", "pPO$")](
            _0x315316[_0x1ddd("‮58", "1YB6")](_0x546cf9, {
              size: _0x206afa,
              customDict: _0x2622d9,
            }),
            ""
          ),
          _0x5a2a1e
        ),
        _0x315316[_0x1ddd("‫59", "LONP")](_0x546cf9, {
          size: _0x315316[_0x1ddd("‫5a", "u&v]")](
            _0x315316["DsudJ"](0xe, _0x315316["zEEFY"](_0x206afa, 0x3)),
            0x1
          ),
          customDict: _0x2622d9,
        })
  ...
  let _0x3d7f0d = {
    ...
    headers: {
      ...
      "Content-Type": _0x315316[_0x1ddd("‮5d", "3CPB")],
      "Accept-Encoding": _0x315316[_0x1ddd("‫5e", "FAzh")],
      "Accept-Language": _0x315316[_0x1ddd("‮5f", "6V4W")],
      Origin: _0x315316[_0x1ddd("‮60", "[SPd")],
      Referer: _0x315316["nThgL"],
      "User-Agent": _0x315316[_0x1ddd("‮61", "3CPB")],
    },
    body:
      _0x1ddd("‫62", "PmwU") +
      $["fp"] +
      "\x22,\x22appId\x22:\x228adfb\x22,\x22timestamp\x22:" +
      Date["now"]() +
      ",\x22platform\x22:\x22web\x22,\x22expandParams\x22:\x22\x22}",
  };
  return new Promise(async (_0x5b363f) => {
    var _0x23a6df = {
      dZOKU: function (_0x543f60, _0x2b2503) {
        return _0x315316[_0x1ddd("‫63", "MwfJ")](_0x543f60, _0x2b2503);
      },
      mcuGV: function (_0x18e064, _0xe19e9f) {
        return _0x315316["pCsmG"](_0x18e064, _0xe19e9f);
      },
      OJchi: function (_0x4227fc, _0x10c275) {
        return _0x315316[_0x1ddd("‮64", "6V4W")](_0x4227fc, _0x10c275);
      },
      Oqtzc: function (_0x44960d, _0x504db8) {
        return _0x315316[_0x1ddd("‫65", "FnU^")](_0x44960d, _0x504db8);
      },
      yGufO: _0x315316[_0x1ddd("‮66", "HD%2")],
      aqMaz: function (_0x28dbff, _0x349a53) {
        return _0x315316[_0x1ddd("‮67", "d3kj")](_0x28dbff, _0x349a53);
      },
      yGqux: _0x315316[_0x1ddd("‫68", "]9E6")],
      CGDNA: function (_0x65375e) {
        return _0x315316[_0x1ddd("‮69", "KMoy")](_0x65375e);
      },
    };
    if (
      _0x315316[_0x1ddd("‮6a", "Mted")](
        _0x315316[_0x1ddd("‫6b", "#R^r")],
        _0x315316[_0x1ddd("‫6c", "d3kj")]
      )
    ) {
      return _0x315316[_0x1ddd("‫6d", "jF4L")](
        _0x315316[_0x1ddd("‫6e", "Nt$k")](
          e[_0x315316[_0x1ddd("‫6f", "LONP")]],
          ":"
        ),
        e[_0x315316[_0x1ddd("‫70", "]9E6")]]
      );
    } else {
      $[_0x1ddd("‫71", "gZdj")](
        _0x3d7f0d,
        (_0xd9771a, _0xd55247, _0x5a8c6f) => {
          if (
            _0x23a6df[_0x1ddd("‮72", "Yi!%")](
              _0x23a6df[_0x1ddd("‮73", ")aDT")],
              _0x23a6df[_0x1ddd("‫74", "pg08")]
            )
          ) {
            $["logErr"](e, _0xd55247);
          } else {
            try {
              if (
                _0x23a6df["aqMaz"](
                  _0x23a6df[_0x1ddd("‫75", "uJ@m")],
                  _0x23a6df["yGqux"]
                )
              ) {
                ss = _0x23a6df["dZOKU"](
                  _0x23a6df[_0x1ddd("‮76", "]cw5")](_0x546cf9, {
                    size: 0x1,
                    customDict: _0x250a16,
                  }),
                  ""
                ...
                if (
                  _0x23a6df[_0x1ddd("‫77", "6V4W")](
                    _0x5a2a1e["indexOf"](ss),
                    -0x1
                  )
                )
                  _0x5a2a1e += ss;
                ...
                const {
                  ...
                  msg,
                  data: { result } = {},
                } = JSON["parse"](_0x5a8c6f);
                $["token"] = result["tk"];
                $["genKey"] = new Function(
                  _0x1ddd("‮78", "3CPB") + result["algo"]
                )();
              }
            } catch (_0x5bddbe) {
              $[_0x1ddd("‮79", "QJgh")](_0x5bddbe, _0xd55247);
            } finally {
              _0x23a6df[_0x1ddd("‫7a", "Yi!%")](_0x5b363f);
            }
          }
        }
      );
...
function _0x546cf9() {
  var _0x5ec570 = {
    vzgmC: function (_0x44328a, _0x580fdd) {
      return _0x44328a === _0x580fdd;
    },
    pYbvU: function (_0x1f51d8, _0x3e06e5) {
      return _0x1f51d8 < _0x3e06e5;
    },
    UgcIo: function (_0x4f674d, _0x330ec4) {
      return _0x4f674d !== _0x330ec4;
    },
    BktHB: function (_0x158e55, _0x2c9b10) {
      return _0x158e55 === _0x2c9b10;
    },
    hsjEU: _0x1ddd("‫7b", "pPO$"),
    zwnJo: function (_0x1d29bd, _0x4ab3f7) {
      return _0x1d29bd == _0x4ab3f7;
    },
    ecqFY: "string",
    Rpiyn: _0x1ddd("‫7c", "]cw5"),
    bWCtV: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",
    VNhNu: _0x1ddd("‫7d", "3CPB"),
    uiWwa: "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-",
    lJWjQ: "0123456789",
    Gbkmn: function (_0x278d65, _0x36e332) {
      return _0x278d65 === _0x36e332;
    },
    MiQNg: _0x1ddd("‮7e", "YlvL"),
    rUEwY: function (_0x5b3ca9, _0x5890ce) {
      return _0x5b3ca9 | _0x5890ce;
    },
    Irane: function (_0x4760cd, _0x4ea963) {
      return _0x4760cd * _0x4ea963;
    },
    vOphQ: function (_0x985b43, _0x4822dc) {
      return _0x985b43 > _0x4822dc;
    },
    jSzcA: _0x1ddd("‫7f", "lyrP"),
    xmxha: "DbUrR",
  };
  var _0x438bc3,
    _0x1a0059,
    _0x3fd434 = _0x5ec570[_0x1ddd("‮80", "FnU^")](
      void 0x0,
      (_0x25d4b8 = (_0x1a0059 =
        _0x5ec570[_0x1ddd("‮81", "1YB6")](
          0x0,
          arguments[_0x1ddd("‮82", "FnU^")]
        ) && _0x5ec570[_0x1ddd("‫83", "y4&8")](void 0x0, arguments[0x0])
          ? arguments[0x0]
          : {})["size"])
    )
      ? 0xa
      : _0x25d4b8,
    _0x25d4b8 = _0x5ec570[_0x1ddd("‫84", "Mted")](
      void 0x0,
      (_0x25d4b8 = _0x1a0059[_0x1ddd("‫85", ")Ode")])
    )
      ? _0x5ec570[_0x1ddd("‮86", "1YB6")]
      : _0x25d4b8,
    _0x2a01e3 = "";
  if (
    (_0x1a0059 = _0x1a0059[_0x1ddd("‮87", "H#OK")]) &&
    _0x5ec570[_0x1ddd("‮88", "!UFB")](
      _0x5ec570[_0x1ddd("‮89", "i$U2")],
      typeof _0x1a0059
    )
  )
    _0x438bc3 = _0x1a0059;
    ...
    switch (_0x25d4b8) {
      case _0x5ec570["Rpiyn"]:
        _0x438bc3 = _0x5ec570[_0x1ddd("‮8a", "^2DS")];
        break;
      case _0x5ec570["VNhNu"]:
        _0x438bc3 = _0x5ec570[_0x1ddd("‮8b", "FAzh")];
        break;
      case _0x5ec570["hsjEU"]:
      default:
        _0x438bc3 = _0x5ec570[_0x1ddd("‮8c", "YlvL")];
    }
  if (
    _0x5ec570[_0x1ddd("‫8d", "QJgh")](
      $["name"]["indexOf"](_0x5ec570[_0x1ddd("‮8e", "^2DS")]),
      -0x1
    )
  )
    return "1";
  for (; _0x3fd434--; )
    _0x2a01e3 +=
      _0x438bc3[
        _0x5ec570[_0x1ddd("‮8f", "Mr7]")](
          _0x5ec570["Irane"](
            Math[_0x1ddd("‫90", "YlvL")](),
            _0x438bc3[_0x1ddd("‮91", ")Ode")]
          ),
          0x0
        )
      ];
  if (
    _0x5ec570[_0x1ddd("‮92", "pPO$")](
      new Date()[_0x1ddd("‮93", "pPO$")](),
      0x18021b2af00
    )
  ) {
    if (
      _0x5ec570["UgcIo"](_0x5ec570[_0x1ddd("‫94", "t&pr")], _0x5ec570["xmxha"])
    ) {
      return "1";
    } else {
      return "1";
